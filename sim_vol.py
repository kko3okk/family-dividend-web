...
V=[
 ("R9","九行基準",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167)),
 ("S1","同子產業最多1檔",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,per_sub=1)),
 ("S2","同子產業最多2檔",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,per_sub=2)),
 ("S3","擴散度≥60%連3月的成熟子產業不新進",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,no_mature=True)),
 ("S4","20日平均日振幅>4%不進",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,vol_max=4.0)),
 ("S5","20日平均日振幅>4%部位減半",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,vol_half=4.0)),
 ("S6","20日平均日振幅>3%部位減半",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,vol_half=3.0)),
 ("S7","S1＋S3",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,per_sub=1,no_mature=True)),
 ("S8","S1＋S5",dict(swing=False,cum_min=30,in_map=True,trail=0.25,gain_min=1.0,maxpos=5,pospct=0.167,rule9=0.167,per_sub=1,vol_half=4.0)),
]
rows=[]
for k,desc,opt in V:
    m,tr=run(opt)
    rows.append([k,desc,f"{m['ret']:+.2f}",f"{m['mdd']:.2f}",m["trades"],m["ent"],f"{m['win']:.0f}",m["hold"],f"{m['final']:,.0f}"])
    with open(f"{OUT}/vol_{k}_trades.csv","w",newline="",encoding="utf-8-sig") as f:
...
with open(f"{OUT}/vol_summary.csv","w",newline="",encoding="utf-8-sig") as f:
